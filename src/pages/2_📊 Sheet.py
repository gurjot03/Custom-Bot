...
from modules.custom_sheet.table_tool import PandasAgent
...
table_tool_module = reload_module('modules.custom_sheet.table_tool')
...
if not user_api_key:
    ...
    if uploaded_file:
        ...
        with st.form(key="query"):
            ...
            query = st.text_input("Ask the question", value="", type="default", 
